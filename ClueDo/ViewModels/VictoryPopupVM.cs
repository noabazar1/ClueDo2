...
/// <summary>
/// class for the victory popup, which is shown when the player wins the game. It has a button to go back
/// to the main menu.
/// </summary>
/// <param name="popup"></param>
public partial class VictoryPopupVM(Popup popup) : Models.ObservableObject
{
